...
class AppColors {
  ...
  static const primaryLight = Color(
    0xFF007AFF,
  ); // Canlı Mavi - Onboarding, splash, vurgular
  static const secondaryLight = Color(
    0xFF5AC8FA,
  ); // Açık Mavi - Hover, ikincil vurgular
  ...
  static const secondaryDark = Color(
    0xFF7DD3FC,
  ); // Daha açık Mavi - Dark mode hover
  ...
  static const discountRed = Color(
    0xFFDC2626,
  ); // Kan Kırmızısı - İndirimler, vurgular
  static const discountRedLight = Color(
    0xFFFFEBEE,
  ...
  static const error = Color(
    0xFFDC2626,
  ); // Kan Kırmızısı (discountRed ile aynı)
  ...
  static const opportunityRed = Color(
    0xFFDC2626,
  ); // Kan Kırmızısı (indirim vurgusu)
  ...
  static const opportunityBlue = Color(
    0xFF007AFF,
  ); // Canlı Mavi (primary ile aynı)
  static const opportunityBlueLight = Color(0xFFEBF4FF); // Açık Mavi
  static const opportunityBlueSecondary = Color(
    0xFF5AC8FA,
  ); // Açık Mavi (secondary ile aynı)
  static const opportunityBlueSecondaryLight = Color(
    0xFFE0F2FE,
  ); // Çok açık mavi
  ...
  static const shadowMedium = Color(
    0x0D000000,
  ...
  static const badgeBackground = Color(
    0xFFEBF4FF,
  ); // Açık Mavi - Vurgu alanları
  static const badgeText = Color(0xFF007AFF); // Canlı Mavi - Vurgu metinleri
  static const badgeTextSecondary = Color(
    0xFF5AC8FA,
  ); // Açık Mavi - İkincil vurgular
  ...
  static const overlayWhiteLight = Color(
    0x80FFFFFF,
  ); // white.withValues(alpha: 0.5)
  static const overlayWhiteVeryLight = Color(
    0x66FFFFFF,
  ); // white.withValues(alpha: 0.4)
  static const overlayBlack = Color(
    0x0D000000,
  ); // black.withValues(alpha: 0.05)
  ...
  static const filterBlueLight = Color(
    0xFF5AC8FA,
  ); // Açık Mavi (secondary ile aynı)
  ...
  static const onboardingBackground = Color(
    0xFF007AFF,
  ); // Canlı Mavi - Onboarding arka plan
  ...
  static const buttonPressed = Color(
    0xFF003D9E,
  ); // Daha koyu Mavi - Press durumu
  static const interactiveBlue = Color(
    0xFF007AFF,
  ); // Canlı Mavi - İnteraktif öğeler
  static const interactiveBlueLight = Color(
    0xFFEBF4FF,
  ); // Açık Mavi - Hover arka plan
