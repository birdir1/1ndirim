...
- **Hizmet Sağlayıcılar:** Uygulama hizmetlerini sağlamak için çalıştırdığımız güvenilir üçüncü taraf servisler (ör. hosting, analitik)
...
Ancak, hiçbir internet tabanlı sistem %100 güvenli değildir. Verilerinizin güvenliğini garanti edemeyiz.
...
Uygulama, kullanıcı tercihlerini saklamak ve uygulama performansını analiz etmek için çerezler ve benzeri teknolojiler kullanabilir.

---

## 7. Üçüncü Taraf Bağlantılar

Uygulama, banka ve operatör web sitelerine bağlantılar içerebilir. Bu web sitelerinin gizlilik uygulamalarından sorumlu değiliz. Üçüncü taraf web sitelerini ziyaret ettiğinizde gizlilik politikalarını incelemenizi öneririz.

---

## 8. Çocukların Gizliliği

Uygulama 13 yaşın altındaki çocuklardan bilerek kişisel bilgi toplamaz. 13 yaşın altındaki bir çocuğun bilgilerini topladığımızı fark edersek, bu bilgileri derhal sileriz.
...
Bu haklarınızı kullanmak için bizimle iletişime geçebilirsiniz: [İletişim Bilgileri]

---

## 10. Gizlilik Politikası Değişiklikleri

Bu Gizlilik Politikasını zaman zaman güncelleyebiliriz. Değişiklikler yapıldığında, uygulama içinde bildirim göndereceğiz ve "Son Güncelleme" tarihini güncelleyeceğiz.
...
## 12. KVKK (Kişisel Verilerin Korunması Kanunu)
...
**Not:** Bu gizlilik politikası Türkçe ve İngilizce olarak sunulmaktadır. Herhangi bir çeviri farklılığı durumunda Türkçe versiyon geçerlidir.
