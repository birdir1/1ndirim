...
const sources = [
  ...
  // Fashion (Top 10)
  { name: 'Zara', type: 'fashion', websiteUrl: 'https://www.zara.com/tr/' },
  { name: 'H&M', type: 'fashion', websiteUrl: 'https://www2.hm.com/tr_tr/index.html' },
  { name: 'Bershka', type: 'fashion', websiteUrl: 'https://www.bershka.com/tr/' },
  { name: 'Pull&Bear', type: 'fashion', websiteUrl: 'https://www.pullandbear.com/tr/' },
  { name: 'LCW', type: 'fashion', websiteUrl: 'https://www.lcwaikiki.com/tr-TR/TR' },
  { name: 'Koton', type: 'fashion', websiteUrl: 'https://www.koton.com/tr/' },
  { name: 'Mavi', type: 'fashion', websiteUrl: 'https://www.mavi.com/' },
  { name: 'DeFacto', type: 'fashion', websiteUrl: 'https://www.defacto.com.tr/' },
  { name: 'Collins', type: 'fashion', websiteUrl: 'https://www.collins.com.tr/' },
  { name: 'Beymen', type: 'fashion', websiteUrl: 'https://www.beymen.com/tr' },
  // Cosmetics (Top 5)
  { name: 'Sephora', type: 'cosmetics', websiteUrl: 'https://www.sephora.com.tr/' },
  { name: 'Gratis', type: 'cosmetics', websiteUrl: 'https://www.gratis.com/' },
  { name: 'Watsons', type: 'cosmetics', websiteUrl: 'https://www.watsons.com.tr/' },
  { name: 'MAC Cosmetics', type: 'cosmetics', websiteUrl: 'https://www.maccosmetics.com.tr/' },
  { name: 'Flormar', type: 'cosmetics', websiteUrl: 'https://www.flormar.com.tr/' },
  // Travel
  { name: 'Pegasus', type: 'travel', websiteUrl: 'https://www.flypgs.com/kampanyalar' },
  { name: 'Setur', type: 'travel', websiteUrl: 'https://www.setur.com.tr/kampanyalar' },
  { name: 'ETS', type: 'travel', websiteUrl: 'https://www.etstur.com/kampanyalar' },
  { name: 'Odamax', type: 'travel', websiteUrl: 'https://www.odamax.com/kampanyalar' },
  // Entertainment / Ticketing
  { name: 'Passo', type: 'entertainment', websiteUrl: 'https://www.passo.com.tr/kampanyalar' },
  { name: 'Müzekart', type: 'entertainment', websiteUrl: 'https://www.muze.gov.tr/muzekart' },
  { name: 'Biletix', type: 'entertainment', websiteUrl: 'https://www.biletix.com/kampanyalar' },
];
