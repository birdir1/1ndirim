/**
 * Halkbank Fetch Scraper
 * FAZ 7.4: Halkbank için fetch-based scraper (SPA yapı nedeniyle)
...
class HalkbankFetchScraper extends BaseFetchScraper {
  constructor() {
    super('Halkbank', 'https://www.halkbank.com.tr');
  ...
  getApiEndpoint() {
    if (!this.apiEndpoint) {
      throw new Error('Halkbank: API endpoint tanımlanmamış. Network analizi yapılmalı.');
    }
  ...
  parseApiResponse(data) {
    ...
    console.warn('⚠️ Halkbank: parseApiResponse() henüz implement edilmedi. Network analizi gerekli.');
    return campaigns;
  }
...
module.exports = HalkbankFetchScraper;
