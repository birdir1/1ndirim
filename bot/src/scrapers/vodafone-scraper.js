...
class VodafoneScraper extends BaseScraper {
  constructor() {
    super('Vodafone', 'https://www.vodafone.com.tr/kampanyalar');
  }

  /**
   * Vodafone kampanyalarını scrape eder
   */
  async scrape() {
    const campaigns = [];

    try {
      // Vodafone kampanya sayfasını yükle
      ...
      throw new Error(`Vodafone scraper hatası: ${error.message}`);
    }
  }
...
module.exports = VodafoneScraper;
